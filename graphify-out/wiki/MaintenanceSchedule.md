...
> God node · 53 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\maintenance.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/maintenance.py#L7)
...
sequenceDiagram
    ...
    participant P201 as ServiceRecord
    ...
    participant P218 as create_maintenance_schedule()
    participant P219 as bulk_accept_maintenance_schedules()
    participant P220 as get_maintenance_schedules()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
