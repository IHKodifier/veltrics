...
> God node · 52 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\maintenance.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/maintenance.py#L28)
...
sequenceDiagram
    ...
    participant P217 as MaintenanceSchedule
    participant P218 as AuditLog
    ...
    participant P240 as log_maintenance_task()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
