...
> God node · 31 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\driver.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/driver.py#L7)
...
sequenceDiagram
    ...
    participant P219 as ServiceRecord
    participant P220 as OrganizationInvitation
    ...
    participant P233 as UC-064: Get high-level KPI dashboard metrics summary for active organization.
    participant P234 as UC-065: Cost Breakdown Charts per Vehicle (Fuel vs Maintenance vs Expenses).
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
