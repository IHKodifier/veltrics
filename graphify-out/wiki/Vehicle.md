...
> God node · 115 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\vehicle.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/vehicle.py#L20)
...
sequenceDiagram
    ...
    participant P216 as MaintenanceSchedule
    ...
    participant P240 as create_vehicle()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
