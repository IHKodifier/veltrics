...
> God node · 178 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\vehicle.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/vehicle.py#L20)
...
sequenceDiagram
    ...
    participant P275 as MaintenanceSchedule
    ...
    participant P311 as create_vehicle()
    participant P312 as test_uc096_delta_sync_with_since_timestamp()
    participant P313 as test_uc094_sync_conflict_server_wins()
    participant P314 as test_uc096_delta_sync_full_snapshot()
    participant P315 as test_uc031_restore_vehicle_quota_exceeded()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
