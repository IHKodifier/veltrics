...
> God node · 54 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\driver.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/driver.py#L7)
...
sequenceDiagram
    ...
    participant P249 as Vehicle
    participant P250 as AuditLog
    participant P251 as MaintenanceSchedule
    participant P252 as ServiceRecord
    participant P253 as UserOrganization
    ...
    participant P266 as UC-064: Get high-level KPI dashboard metrics summary for active organization.
    participant P267 as UC-065: Cost Breakdown Charts per Vehicle (Fuel vs Maintenance vs Expenses).
    participant P268 as create_driver()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
