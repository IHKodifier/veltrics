...
> God node · 65 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\driver.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/driver.py#L7)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as Driver
    ...
    participant P277 as ServiceRecord
    participant P278 as AuditLog
    participant P279 as UserOrganization
    ...
    participant P299 as UC-065: Cost Breakdown Charts per Vehicle (Fuel vs Maintenance vs Expenses).
    participant P300 as create_driver()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
