...
> God node · 82 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\maintenance.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/maintenance.py#L7)
...
sequenceDiagram
    ...
    participant P258 as create_maintenance_schedule()
    participant P259 as bulk_accept_maintenance_schedules()
    participant P260 as get_maintenance_schedules()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
