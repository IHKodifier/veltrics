...
> God node · 101 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\maintenance.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/maintenance.py#L31)
...
sequenceDiagram
    ...
    participant P276 as MaintenanceSchedule
    ...
    participant P311 as log_maintenance_task()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
