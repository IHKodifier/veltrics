...
> God node · 85 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\user_organization.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/user_organization.py#L8)
...
sequenceDiagram
    ...
    participant P298 as UC-044: Log Vehicle Safety Inspection Checklist.
    participant P299 as UC-044: Fetch Vehicle Safety Inspections.
    participant P300 as UC-043: Create Maintenance Vendor.
    participant P301 as UC-043: List Maintenance Vendors.
    participant P302 as accept_organization_invitation()
    participant P303 as redeem_organization_invitation_code()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
