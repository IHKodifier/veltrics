...
> God node · 42 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\user_organization.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/user_organization.py#L8)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as UserOrganization
    ...
    participant P257 as accept_organization_invitation()
    participant P258 as redeem_organization_invitation_code()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
### contains
- [[user_organization.py]] `EXTRACTED`
