...
> God node · 45 connections · [E:\Non_Office\Dev_Space\vibe_skool\veltrics\src\backend\app\models\fuel_log.py](file:///E:/Non_Office/Dev_Space/vibe_skool/veltrics/src/backend/app/models/fuel_log.py#L6)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as FuelLog
    ...
    participant P292 as log_fuel_entry()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
- [[setup_database()]] `INFERRED`
- [[setup_db()]] `INFERRED`
- [[log_fuel_entry()]] `INFERRED`

### contains
- [[fuel_log.py]] `EXTRACTED`
...
- [[Helper to convert SQLAlchemy model instance to dict.]] `INFERRED`
- [[UC-119: Offline Sync Batch Transaction Engine.     Processes operation envelopes]] `INFERRED`
- [[UC-096: Delta Sync Payload Fetching (Incremental Catch-up).     Returns active e]] `INFERRED`
- [[UC-067: Verify Fleet Manager Web Dashboard KPI Aggregation.]] `INFERRED`
- [[UC-068: Verify Fleet Cost Ranking Table & Heatmap endpoint.]] `INFERRED`
- [[UC-069: Verify Fleet Vehicle Availability Widget endpoint.]] `INFERRED`
- [[UC-071: Verify customizing & saving dashboard widget layout preferences.]] `INFERRED`
- [[UC-110: Verify Exporting Maintenance History to PDF.]] `INFERRED`
